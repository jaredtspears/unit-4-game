...
// target number is on the screen!
var targetNumber = 53; 
...
function intGame() {
    ...
    for (var i = 0; i < numberOptions.length; i++) {
        ...
        // trying to see if I can return "this" which would be the source of the images
    ...
    $(".crystal-image").on("click", function() {
            ...
            counter += crystalValue;
                ...
                //below line NOT APPENDING?
                $(".currentSummed").append("Where you stand currently: " + counter );

                    // the old code ...   alert("New score: " + counter);

            //the below code is the old code from the activity (reminder ln 7 locates var targetNumber)
